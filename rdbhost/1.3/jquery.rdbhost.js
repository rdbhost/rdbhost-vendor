...
(function ($, window) {
  ...
  function SQLEngine(dbRole, authcode, domain) {
    ...
    this.version = this.prototype.version = 'jquery.rdbhost.js 1.3';
   ...
   *   the hash string, or auth info in cookie named 'FEDAUTH_KEY'.
   *
   ...
   *   ignoreHash: set true to ignore url#hash value, and rely only on FEDAUTH_KEY cookie  -- default false
   *
  ...
  R.loginOpenId = function (inp) {
    ...
    // get cookie, if available
        var openidCookie = $.cookie('FEDAUTH_KEY');
  ...
  /*
    ...
    R.loginOAuth = function (inp) {
        ...
        // get cookie, if available
        var oauthCookie = $.cookie('FEDAUTH_KEY');
